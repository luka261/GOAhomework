...
random = ["red", "black", "purple", "way", "here", "help"]
upper = random[0].upper() 
lower = random[1].lower()
capitalize = random[2].capitalize() 
swapcase = random[3].swapcase()
find = random[4].find("l")
